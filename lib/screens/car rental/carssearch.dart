...
class _CarsSearchState extends State<CarsSearch> with TickerProviderStateMixin {
    ...
    list.sort((a, b) {
      switch (_sortOption) {
        case CarSortOption.priceLow:
          return ((a['pricePerDay'] as num?) ?? 0)
              .compareTo((b['pricePerDay'] as num?) ?? 0);
        case CarSortOption.priceHigh:
          return ((b['pricePerDay'] as num?) ?? 0)
              .compareTo((a['pricePerDay'] as num?) ?? 0);
        case CarSortOption.nameAZ:
          return (a['name'] as String? ?? '')
              .compareTo(b['name'] as String? ?? '');
        case CarSortOption.seatsLow:
          return ((a['seats'] as int?) ?? 0)
              .compareTo((b['seats'] as int?) ?? 0);
        case CarSortOption.seatsHigh:
          return ((b['seats'] as int?) ?? 0)
              .compareTo((a['seats'] as int?) ?? 0);
      }
    });
    return list;
  }
    ...
    switch (_currentStep) {
      case BookingStep.tripDetails:
        if (selectedAirport == null) {
          _showSnack(l.selectLocationsError);
          return false;
        }
        if (pickupDateTime == null || dropoffDateTime == null) {
          _showSnack(l.selectDatesError);
          return false;
        }
        if (dropoffDateTime!.isBefore(pickupDateTime!)) {
          _showSnack(l.dropoffBeforePickup);
          return false;
        }
        return true;
      case BookingStep.chooseCar:
        if (selectedCar == null) {
          _showSnack(l.selectCarError);
          return false;
        }
        return true;
    ...
    return Container(
      ...
      child: Row(children: [
        GestureDetector(
          onTap: () {
            if (_currentStep.index > 0)
              _goToStep(BookingStep.values[_currentStep.index - 1]);
            else
          ...
          child: Container(
            ...
            height: 38,
            decoration: BoxDecoration(
                color: t.backBg, borderRadius: BorderRadius.circular(10)),
        ...
        Expanded(
          ...
          Text(_stepTitle(l),
              style: TextStyle(
                  color: t.title, fontSize: 17, fontWeight: FontWeight.bold)),
  ...
  String _stepTitle(AppLocalizations l) {
    switch (_currentStep) {
      case BookingStep.tripDetails:
        return l.tripDetails;
      case BookingStep.chooseCar:
        return l.carRentTitle;
      case BookingStep.personalInfo:
        return l.yourInformation;
      case BookingStep.review:
        return l.reviewAndConfirm;
    }
  }
              ...
              children: [
                Text(
                    ...
                    style: TextStyle(
                        ...
                        color: t.price)),
                Text(
                    '$totalDays ${totalDays == 1 ? l.day : l.days} ${l.total2}',
            ...
            ClipRRect(
              ...
              child: SizedBox(
                ...
                child: FlutterMap(
                  ...
                  options: MapOptions(
                    initialCenter:
                        LatLng(selectedAirport!.lat, selectedAirport!.lng),
                    initialZoom: 14,
                        ...
                        children: [
                          ...
                          ...entry.value.map((airport) => InkWell(
                                onTap: () {
                                  ...
                                  _mapController.move(
                                      LatLng(airport.lat, airport.lng), 14);
                                },
                                child: Padding(
                                  padding: const EdgeInsets.symmetric(
          ...
          ...options.map((opt) {
            ...
            return InkWell(
              ...
              child: Container(
                ...
                child: Row(children: [
                  Icon(opt.$3,
                      size: 18, color: isSelected ? t.accent : t.label),
                  const SizedBox(width: 12),
                  Expanded(
                      child: Text(opt.$2,
                          style: TextStyle(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected
              ...
              : [
                  BoxShadow(
                      color: t.cardBorder.withOpacity(0.08),
                      blurRadius: 6,
                      offset: const Offset(0, 2))
                ],
        ),
            ...
            child:
              ...
              Row(children: [
                ...
                Container(
                    ...
                    height: 3,
                    decoration: BoxDecoration(
                        color: t.cardBorder, shape: BoxShape.circle)),
                const SizedBox(width: 6),
                Text(fuel,
                    style: TextStyle(
                        fontSize: 12,
              ...
              Row(children: [
                ...
                const SizedBox(width: 8),
                _miniSpec(
                    Icons.settings_outlined, car['transmission'] ?? '-', t),
              ]),
            ]),
          ),
    ...
    return SingleChildScrollView(
      ...
      child: _sectionCard(t, children: [
        _formField(firstNameCtrl, l.firstName, t,
            ...
            errorText: _firstNameError != null
                ? _resolveError(_firstNameError, l)
                : null),
        const SizedBox(height: 14),
        _formField(lastNameCtrl, l.lastName, t,
            icon: Icons.person_outline,
            errorText: _lastNameError != null
                ? _resolveError(_lastNameError, l)
                : null),
        const SizedBox(height: 14),
        _formField(emailCtrl, l.email, t,
            ...
            errorText:
                _emailError != null ? _resolveError(_emailError, l) : null),
        const SizedBox(height: 14),
        _formField(phoneCtrl, l.phone, t,
            icon: Icons.phone_outlined,
            keyboardType: TextInputType.phone,
            errorText:
                _phoneError != null ? _resolveError(_phoneError, l) : null),
      ]),
    );
  }
            ...
            Expanded(
                child: Column(
                  ...
                  Text(l.carsCashPaymentBody,
                      style:
                          TextStyle(fontSize: 12, color: t.sub, height: 1.5)),
                ])),
          ]),
        ),
              ...
              ClipRRect(
                ...
                child: Container(
                  ...
                  child: selectedCar!['image'] != null
                      ? Image.network(selectedCar!['image'],
                          width: 80,
                          height: 52,
                          fit: BoxFit.contain,
  ...
  Widget _reviewRow(String label, String value, AppThemeExtension t,
    ...
    return Row(children: [
      if (icon != null) ...[
        Icon(icon, size: 14, color: t.label),
        const SizedBox(width: 6)
      ],
        ...
        child: Row(children: [
          ...
          Expanded(
            ...
            decoration: InputDecoration(
              ...
              contentPadding:
                  EdgeInsets.fromLTRB(icon != null ? 8 : 16, 14, 16, 14),
            ),
          )),
        ]),
      ),
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(
            ...
            child:
                Icon(icon, color: hasValue ? Colors.white : t.label, size: 18),
          ),
          const SizedBox(width: 12),
          Expanded(
              child: Text(_formatDateTime(value, l),
                  style: TextStyle(
                      color: hasValue ? t.title : t.label,
                      fontSize: 14,
                      fontWeight:
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Text(l.promoCode,
              style: TextStyle(
                  fontSize: 14, fontWeight: FontWeight.w600, color: t.title)),
        ]),
        const SizedBox(height: 10),
        if (_appliedPromo == null) ...[
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Expanded(
              ...
              style:
                  TextStyle(color: t.title, letterSpacing: 1.2, fontSize: 14),
              onChanged: (_) {
        ...
        child: Padding(
          ...
          child: Column(children: [
            ...
            Container(
              ...
              height: 96,
              decoration:
                  BoxDecoration(color: t.successBg, shape: BoxShape.circle),
            ...
            Text(l.bookingConfirmedTitle,
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontSize: 28, fontWeight: FontWeight.bold, color: t.title)),
            const SizedBox(height: 12),
