...
class _HotelResultsState extends State<HotelResults> {
  ...
  void applyFilters() {
    ...
    if (searchQuery.isNotEmpty) {
      result = result
          .where((h) => h['title'].toString().toLowerCase().contains(searchQuery.toLowerCase()))
          .toList();
    }
      ...
      builder: (_) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Text(l.sortBy, style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
              SizedBox(height: 12),
              ...{
                ...
                return ListTile(
                  ...
                  title: Text(e.value),
                  trailing: selected ? Icon(Icons.check, color: _teal) : null,
                  onTap: () {
          ...
          builder: (ctx, setSheet) {
            return Padding(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(l.filter, style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
                  SizedBox(height: 16),
                  Text(l.propertyRating, style: TextStyle(fontWeight: FontWeight.w600)),
                  SizedBox(height: 8),
                  Wrap(
                    spacing: 8,
                    children: ['5', '4'].map((r) {
                  ...
                  SizedBox(height: 16),
                  Text(l.view, style: TextStyle(fontWeight: FontWeight.w600)),
                  SizedBox(height: 8),
                  Wrap(
                    spacing: 8,
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          onPressed: () {
                            setState(() { selectedRating = null; selectedView = null; });
                            applyFilters();
                            Navigator.pop(context);
                          },
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            setState(() { selectedRating = tempRating; selectedView = tempView; });
                            applyFilters();
                            Navigator.pop(context);
                          },
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            label: Text('Retry'),
            style: ElevatedButton.styleFrom(
                shape: StadiumBorder(), backgroundColor: _teal, foregroundColor: Colors.white),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    if (hasError) return Scaffold(body: _buildError());
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: Container(
              ...
              child: TextField(
                ...
                onChanged: (val) { searchQuery = val; applyFilters(); },
                decoration: InputDecoration(
                  ...
                  suffixIcon: searchQuery.isNotEmpty
                      ? IconButton(
                          ...
                          onPressed: () { searchController.clear(); searchQuery = ''; applyFilters(); })
                      : null,
                ),
              ),
            ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                _actionChip(Icons.swap_vert, l.sortBy, sortOption != null, () => showSortSheet(l)),
                SizedBox(width: 10),
                _actionChip(Icons.tune, l.filter, hasActiveFilters, () => showFilterSheet(l)),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Center(
              child: Text(l.propertiesFound(filteredHotels.length, widget.destination),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 12),
                        Text(l.noPropertiesMatch, style: TextStyle(color: Colors.grey)),
                      ],
                    ),
                  )
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) => _buildHotelCard(filteredHotels[index], l),
                  ),
          ),
        ],
      ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: active ? _teal : Colors.grey[300]!),
          borderRadius: BorderRadius.circular(20),
        ),
        child: Row(
          children: [
            Icon(icon, size: 16, color: active ? _teal : Colors.grey[700]),
            SizedBox(width: 6),
            Text(label,
                style: TextStyle(fontSize: 13, color: active ? _teal : Colors.grey[700],
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      setState(() {
                        if (allIndex != -1) allHotels[allIndex]["isFavorite"] = !isFavorite;
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            Text(rating, style: const TextStyle(color: Colors.cyan,
                  ...
                  Text("SAR $price", style: const TextStyle(fontSize: 20,
                      fontWeight: FontWeight.bold, color: Colors.cyan)),
                  Text(l.totalPriceOneNight,
